use crate::misc::{Color, Rectangle, WindowDimensions};
use minifb::*;
...
impl Graphics {
    ...
    pub fn pixel(&mut self, rect: Rectangle, color: Color) {
        self.buffer[rect.y * self.dimensions.width + rect.x] = color.raw();
    }
